...
const IngredientDeleteOverview = ({
  ...
  return (
    <div
      className={`fixed rounded-t-3xl w-full px-5 py-6 flex flex-col justify-center gap-4 bottom-16 max-w-[568px] bg-white border-t-4 border-t-positive-200 border-x-4 border-x-positive-200 z-50`}
    >
