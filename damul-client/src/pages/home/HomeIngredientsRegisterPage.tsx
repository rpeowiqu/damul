        ...
        <>
          <div className="flex justify-between">
            <DamulButton
              ...
              className="flex items-center justify-end active:scale-95"
            >
          ...
          <div className="flex flex-col gap-3 justify-center">
            ...
            <div className="flex flex-col gap-4 h-60 border border-normal-100 overflow-y-auto">
          ...
          <div className="flex justify-between px-6 py-2">
            <button
              type="button"
              className="active:bg-positive-200 w-6 h-6 rounded-full transition ease-in-out duration-150 active:scale-95"
